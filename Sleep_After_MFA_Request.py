...
This extension is helpful not only for solving this Burp Suite issue, but any type of requests that require a waiting time period before issuing the next request. 
